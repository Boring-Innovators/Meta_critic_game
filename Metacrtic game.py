...
with open("existing_websites_top.txt", "r") as file:
    ...
    for event in pygame.event.get():
        ...
        if realgame_rect.collidepoint(mouse_pos):
            if pygame.mouse.get_pressed()[0]:
                print("Left-click event detected on realgame cover")
                color = (0,255,0)
                realgame_rect, fakegame1_rect, fakegame2_rect = generateBoard(color)
            ...
            if pygame.mouse.get_pressed()[0]:
                color = (255,0,0)
                print("Left-click event detected on fakegame1 cover")
                realgame_rect, fakegame1_rect, fakegame2_rect = generateBoard(color)
                
        elif fakegame2_rect.collidepoint(mouse_pos):
            if pygame.mouse.get_pressed()[0]:
                color = (255,0,0)
                print("Left-click event detected on fakegame2 cover")
                realgame_rect, fakegame1_rect, fakegame2_rect = generateBoard(color)
